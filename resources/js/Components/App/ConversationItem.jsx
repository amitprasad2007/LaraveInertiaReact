...
import {formatMessageDateShort} from "@/helper.jsx";
...
export default function ConversationItem({
    ...
    return (
        <Link
            ...
            preserveState
            className={
                "conversation-item flex items-center gap-2 b-2 text-gray-300 transition-all cursor-pointer border-l-4 hover:bg-black/30 "+
                classes +
